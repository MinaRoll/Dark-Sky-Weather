...
$(document).ready(function() {
	...
	.done(function(info) {
		...
		info.daily.info.forEach(function(weekend){
			var max = ((((weekend.apparentTemperatureMax-32) * 5/9).toFixed(1)));
			var min = ((((weekend.apparentTemperatureMin-32) * 5/9).toFixed(1)));
			var icon = weekend.icon;
			console.log(icon);
